    ...
    return u.easings = {
        ...
        return _createClass(a, [{
            ...
            value: function () {
                ...
                "vertical" !== this.textFormat && (this.graph.text.el.hasAttribute("dominant-baseline") ? this.graph.text.attr("dominant-baseline", "central") : this.graph.text.attr("dy", "0.4em"), this.graph.text.attr("dx", "-0.05em"))
            }
        }, {
            key: "_updateGraph",
            value: function () {
